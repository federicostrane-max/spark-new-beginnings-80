-- Add Pipeline A-Hybrid to match_documents RPC for semantic search
...
BEGIN
  ...
  -- Pipeline A-Hybrid chunks with recursive retrieval
  SELECT 
    pah.id,
    CASE 
      WHEN pah.is_atomic = true AND pah.original_content IS NOT NULL 
