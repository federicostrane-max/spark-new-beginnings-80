-- Extend match_documents to support legacy, Pipeline B, and Pipeline C documents
...
AS $function$
  ...
  -- Pipeline B (pipeline_b_chunks_raw via pipeline_b_agent_knowledge)
  SELECT 
    pbcr.id,
  ...
  -- Pipeline C (pipeline_c_chunks_raw via pipeline_c_agent_knowledge)
  SELECT 
    pccr.id,
