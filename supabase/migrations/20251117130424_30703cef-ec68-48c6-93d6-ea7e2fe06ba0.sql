-- Phase 2: Alignment Prompts v4 - Enhancement with agentType
-- Adds AGENT CONTEXT section with ${agentType} placeholder
-- Requires edge function modification (already done) to pass agentType parameter

-- Disattiva tutti i prompt v3
UPDATE alignment_agent_prompts SET is_active = false WHERE version_number = 3;
...
- System: Multi-agent knowledge alignment system
...
Return ONLY valid JSON:
{
  ...
  'Phase 2: Added AGENT CONTEXT with agentType placeholder'
);
...
## AGENT CONTEXT:
- Agent Type: ${agentType || ''Procedural''}
- Specialization: Workflow and operational knowledge
...
## AGENT CONTEXT:
- Agent Type: ${agentType || ''Narrative''}
- Specialization: Biographical and historical analysis
...
Return ONLY valid JSON:
{
  ...
  true,
  'google/gemini-2.5-flash',
  'Phase 2: Added AGENT CONTEXT with agentType placeholder - CRITICAL for Che Guevara'
);
...
## AGENT CONTEXT:
- Agent Type: ${agentType || ''Technical''}
- Specialization: Engineering and development
...
## AGENT CONTEXT:
- Agent Type: ${agentType || ''Research''}
- Specialization: Academic and analytical analysis
...
## AGENT CONTEXT:
- Agent Type: ${agentType || ''Domain Expert''}
- Specialization: High-stakes professional domain
